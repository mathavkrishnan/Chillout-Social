...
?>
    ...
    <main>
     ...
     <form method="GET" action="homepage.php">
        <button style="background-color:blue;padding: 10px;color:white;borderborder-style: double;position:relative;top:20px;left:1000px;">Profile</button>
     </form>
</form>
     <div style="position:relative;left:300px;top:100px;">
        ...
        if(isset($_POST['posted'])){
         ...
         $sql = "INSERT INTO posts(`name`, `photo`, `text`,`likes`) VALUES('$hello','$filename','$text','0')";
...
?>">
        <div>
          ...
          <textarea rows="6" cols="100" name="text" placeholder="Enter the text......."></textarea>
          </div>
          <button name="posted" type="submit" style="position:relative;background-color:white;left:650px;top:150px;padding:10px;">Post</button>
        </form>
        <div class="cont">
        <?php
          $hello = $_SESSION['username'];
